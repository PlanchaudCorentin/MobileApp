...
/***/ "./src/app/sensor/sensor.page.html":
/*!*****************************************!*\
  !*** ./src/app/sensor/sensor.page.html ***!
  \*****************************************/
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-back-button></ion-back-button>\n    </ion-buttons>\n    <ion-title>{{sensor.name}}</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n\n  <ion-item lines=\"none\">\n    <ion-label>\n      Average\n    </ion-label>\n    <ion-note color=\"primary\" slot=\"end\">50</ion-note>\n  </ion-item>\n\n  <ion-card>\n    <ion-card-header>\n      <ion-card-subtitle>Chart sensors average</ion-card-subtitle>\n    </ion-card-header>\n    <google-chart stye=\"padding:30px\" *ngIf=\"pieChartDataSensor\" [data]=\"pieChartDataSensor\"></google-chart>\n  </ion-card>\n\n\n  <ion-item *ngFor=\"let item of (result | async)\">\n      ID Sensor : {{item.data}} - {{item.data_type}} - {{item.unit}}\n  </ion-item>\n\n\n\n</ion-content>\n"

/***/ }),

/***/ "./src/app/sensor/sensor.page.scss":
/*!*****************************************!*\
  !*** ./src/app/sensor/sensor.page.scss ***!
  \*****************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9zZW5zb3Ivc2Vuc29yLnBhZ2Uuc2NzcyJ9 */"

/***/ }),

/***/ "./src/app/sensor/sensor.page.ts":
/*!***************************************!*\
  !*** ./src/app/sensor/sensor.page.ts ***!
  \***************************************/
/*! exports provided: SensorPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SensorPage", function() { return SensorPage; });
...
var SensorPage = /** @class */ (function () {
    function SensorPage(activatedRoute, devicesService, sensorsService, dataService, route) {
    ...
    SensorPage.prototype.ngOnInit = function () {
        ...
        this.sensor = this.sensorsService.lists.filter(function (e) { return e.id === _this.device.id; });
        this.result = this.dataService.getMetricsBySensor(this.itemInfo);
    };
    SensorPage.prototype.ionViewDidEnter = function () {
        this.useAngularLibrary();
    };
    SensorPage.prototype.itemClicked = function (item) {
        this.route.navigateByUrl('/sensors/' + item.id);
    };
    SensorPage.prototype.useAngularLibrary = function () {
        var _this = this;
        ...
        this.sensor.forEach(function (e) {
            e.data.forEach(function (i) {
                _this.datas = i.data_sensor;
                //console.log(e);
                if (e.id === _this.itemInfo) {
                    _this.datas.forEach(function (key) {
                        _this.lines = [];
                        _this.lines.push(key.hours);
                        _this.lines.push(key.average);
                        _this.lines.push(key.sum);
                        _this.dataTable.push(_this.lines);
                    });
                }
            });
        });
    ...
    SensorPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-sensor',
            template: __webpack_require__(/*! ./sensor.page.html */ "./src/app/sensor/sensor.page.html"),
            styles: [__webpack_require__(/*! ./sensor.page.scss */ "./src/app/sensor/sensor.page.scss")]
        }),
