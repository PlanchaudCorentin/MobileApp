...
var map = {
	...
	"./devices/devices.module": [
		...
		"default~devices-devices-module~sensor-sensor-module~sensors-sensors-module",
		"common",
		"devices-devices-module"
	],
	"./login/login.module": [
...
/* harmony import */ var _services_msal_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./services/msal.service */ "./src/app/services/msal.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _services_msal_service__WEBPACK_IMPORTED_MODULE_11__["MsalService"],
...
(function (SearchType) {
    SearchType["all"] = "";
    SearchType["id"] = "id";
    SearchType["mac_adress"] = "mac_adress";
    SearchType["name"] = "name";
})(SearchType || (SearchType = {}));
var DataService = /** @class */ (function () {
    function DataService(http, msalService) {
        this.http = http;
        this.msalService = msalService;
        this.url = 'http://10.162.129.103:8090/';
        this.url_persistance = 'http://10.162.129.103:8090/';
    }
    DataService.prototype.searchData = function (mail) {
        return this.http.get(this.url + "users/devicesbymail/" + encodeURI(mail));
    };
    DataService.prototype.getSensors = function () {
        return this.http.get(this.url + "sensors/");
    };
    DataService.prototype.getDeviceById = function (id) {
        return this.http.get(this.url + "sensors/device/" + encodeURI(id));
    };
    DataService.prototype.getMetricsBySensor = function (id) {
        return this.http.get(this.url + "metrics/sensor/" + encodeURI(id));
    };
    DataService.prototype.postUser = function (id) {
        return this.http.get(this.url + "metrics/sensor/" + encodeURI(id));
    };
    DataService.prototype.postCommand = function () {
        //return this.http.post(`${this.url_persistance}users/new`, { name: this.msalService.getFullName(), mail: this.msalService.getUserEmail()});
    };
    DataService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _services_msal_service__WEBPACK_IMPORTED_MODULE_3__["MsalService"]])
    ], DataService);
    return DataService;
}());
...
/*!******************************************!*\
  !*** ./src/app/services/msal.service.ts ***!
  \******************************************/
/*! exports provided: MsalService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MsalService", function() { return MsalService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var msal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! msal */ "./node_modules/msal/lib-commonjs/index.js");
/* harmony import */ var msal__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(msal__WEBPACK_IMPORTED_MODULE_2__);
...
var MsalService = /** @class */ (function () {
    function MsalService(http, dataService) {
        this.http = http;
        this.dataService = dataService;
        this.B2CTodoAccessTokenKey = "b2c.access.token";
        this.tenantConfig = {
        ...
        this.authority = "https://login.microsoftonline.com/tfp/" + this.tenantConfig.tenant + "/" + this.tenantConfig.signInPolicy;
        //authority = null;
        /*
         * B2C SignIn SignUp Policy Configuration
         */
        this.clientApplication = new msal__WEBPACK_IMPORTED_MODULE_2__["UserAgentApplication"](this.tenantConfig.clientID, this.authority, function (errorDesc, token, error, tokenType) {
        });
    }
    ...
    MsalService.prototype.signup = function () {
        ...
        this.authenticate();
        //this.dataService.postCommand();
    };
    MsalService.prototype.authenticate = function () {
        var _this = this;
    ...
    ;
    MsalService.prototype.isLoggedIn = function () {
        return this.clientApplication.getUser() != null;
    };
    ;
    MsalService.prototype.getUserEmail = function () {
        return this.getUser().idToken['emails'][0];
    };
    MsalService.prototype.getFullName = function () {
        return this.getUser().idToken['name'];
    };
    MsalService.prototype.getUser = function () {
        return this.clientApplication.getUser();
    };
    MsalService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
...
module.exports = __webpack_require__(/*! /Users/QuentinVarlet/devProject2/src/main.ts */"./src/main.ts");
